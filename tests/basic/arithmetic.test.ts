...
test("arithmetic", () => {
	...
	expect(consoleOutput.printlnLines[4]).toBe("47.34")
	...
	expect(consoleOutput.printlnLines[10]).toBe("-22.66")
	...
	expect(consoleOutput.printlnLines[16]).toBe("431.9")
	expect(consoleOutput.printlnLines[17]).toBe("15234.566840380097")
	expect(consoleOutput.printlnLines[18]).toBe("1")
	...
	expect(consoleOutput.printlnLines[22]).toBe("0.35257143")
	...
	expect(consoleOutput.printlnLines[28]).toBe("12.34")
