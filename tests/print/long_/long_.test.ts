...
test("long printing", () => {
	const className = "tests/print/long_/LongTest"
	...
	expect(consoleOutput.printlnLines[0]).toBe("789654")
	expect(consoleOutput.printlnLines[1]).toBe("741852963")
	expect(consoleOutput.printlnLines[2]).toBe("3333333333333333333")
})
